...
SPARK_LOCAL_IP=192.168.0.152 #, to set the IP address Spark binds to on this node
# - SPARK_PUBLIC_DNS, to set the public DNS name of the driver program
...
#SPARK_WORKER_INSTANCES=2 #, to bind the master to a different IP address or hostname
#SPARK_MASTER_PORT=7077/ #SPARK_MASTER_WEBUI_PORT, to use non-default ports for the master
