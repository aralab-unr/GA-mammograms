...
def fitness_function(genome):
    ...
    query = "python3 -m train --env=" + env + " --logdir=" + logdir + " --n_epochs=" + str(
        epochs_default) + " --num_cpu=" + str(num_cpu) + " --polyak_value=" + str(polyak) + " --gamma_value=" + str(
        gamma) + " --q_learning=" + str(Q_lr) + " --pi_learning=" + str(pi_lr) + " --random_epsilon=" + str(
        random_eps) + " --noise_epsilon=" + str(noise_eps)
